...
module.exports = {
  ...
  entry: {
    vendor: [require.resolve('./polyfills'), 'react', 'react-dom', 'redux', 'react-redux', 'react-router', 'react-router-dom', 'react-loadable', 'redux-thunk'],
  ...
  output: {
    ...
    chunkFilename: 'static/js/[id].[name].[chunkhash:8].chunk.js',
