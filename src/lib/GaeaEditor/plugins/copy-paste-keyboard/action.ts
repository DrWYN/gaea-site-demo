...
export class CopyPasteAction {
  ...
  public pasteToCurrentHoverInstance() {
    ...
    rootInstanceKey && (pasteInstances[rootInstanceKey].parentInstanceKey = this.viewportStore.currentHoverInstanceKey);
    ...
    (this.viewportStore.instances.get(this.viewportStore.currentHoverInstanceKey) as any).childs.push(rootInstanceKey);
  }
}
