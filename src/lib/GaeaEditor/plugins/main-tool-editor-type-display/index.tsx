        ...
        <S.FlexRow style={{ marginTop: 5 }}>
          <ButtonGroup>
            ...
            <Tooltip mouseLeaveDelay={0} title={rowFlexCenter}>
              ...
              >
                <Icon className={isRow ? '' : 'rotate-90'} type="flexDirectionCenter" />
              </ActiveButton>
            </Tooltip>
            <Tooltip mouseLeaveDelay={0} title={rowFlexEnd}>
              ...
              >
                <Icon className={isRow ? '' : 'rotate-90'} type="flexDirectionEnd" />
              </ActiveButton>
            </Tooltip>
            <Tooltip mouseLeaveDelay={0} title={rowFlexSpaceBetween}>
              ...
              >
                <Icon className={isRow ? '' : 'rotate-90'} type="flexSpaceBetween" />
              </ActiveButton>
            </Tooltip>
            <Tooltip mouseLeaveDelay={0} title={rowFlexSpaceAround}>
              ...
              >
                <Icon className={isRow ? '' : 'rotate-90'} type="flexSpaceAround" />
              </ActiveButton>
            </Tooltip>
          </ButtonGroup>
        </S.FlexRow>
        ...
        <S.FlexRow style={{ marginTop: 5 }}>
          <ButtonGroup>
            <Tooltip mouseLeaveDelay={0} title={columnFlexStart}>
              ...
              >
                <Icon className={isRow ? '' : 'rotate-270'} type="flexAlignStart" />
              </ActiveButton>
            </Tooltip>
            <Tooltip mouseLeaveDelay={0} title={columnFlexCenter}>
              ...
              >
                <Icon className={isRow ? '' : 'rotate-270'} type="flexAlignCenter" />
              </ActiveButton>
            </Tooltip>
            ...
            <Tooltip mouseLeaveDelay={0} title={columnFlexStrech}>
              ...
              >
                <Icon className={isRow ? '' : 'rotate-270'} type="flexAlignStretch" />
              </ActiveButton>
            </Tooltip>
            <Tooltip mouseLeaveDelay={0} title={columnFlexBaseline}>
              ...
              >
                <Icon className={isRow ? '' : 'rotate-90'} type="flexBaseline" />
              </ActiveButton>
            </Tooltip>
          </ButtonGroup>
        </S.FlexRow>
